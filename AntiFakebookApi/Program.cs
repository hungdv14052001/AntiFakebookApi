...
using System.Text;
using Quartz;
using AntiFakebookApi.QuaztHelper;
using AntiFakebookApi.Helpers.SocketHelper;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Anti Fakebook", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    ...
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Anti Fakebook v1");
    //
    c.DocumentTitle = "Anti Fakebook API";
